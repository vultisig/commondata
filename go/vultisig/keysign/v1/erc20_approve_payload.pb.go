...
type Erc20ApprovePayload struct {
	...
	// two-message shape.
	ResetAllowanceFirst bool `protobuf:"varint,3,opt,name=reset_allowance_first,json=resetAllowanceFirst,proto3" json:"reset_allowance_first,omitempty"`
}
...
func (x *Erc20ApprovePayload) GetResetAllowanceFirst() bool {
	if x != nil {
		return x.ResetAllowanceFirst
	}
	return false
}
...
var file_vultisig_keysign_v1_erc20_approve_payload_proto_rawDesc = []byte{
	...
	0x69, 0x67, 0x6e, 0x2e, 0x76, 0x31, 0x22, 0x7b, 0x0a, 0x13, 0x45, 0x72, 0x63, 0x32, 0x30, 0x41,
	...
	0x32, 0x0a, 0x15, 0x72, 0x65, 0x73, 0x65, 0x74, 0x5f, 0x61, 0x6c, 0x6c, 0x6f, 0x77, 0x61, 0x6e,
	0x63, 0x65, 0x5f, 0x66, 0x69, 0x72, 0x73, 0x74, 0x18, 0x03, 0x20, 0x01, 0x28, 0x08, 0x52, 0x13,
	0x72, 0x65, 0x73, 0x65, 0x74, 0x41, 0x6c, 0x6c, 0x6f, 0x77, 0x61, 0x6e, 0x63, 0x65, 0x46, 0x69,
	0x72, 0x73, 0x74, 0x42, 0x54, 0x0a, 0x13, 0x76, 0x75, 0x6c, 0x74, 0x69, 0x73, 0x69, 0x67, 0x2e,
