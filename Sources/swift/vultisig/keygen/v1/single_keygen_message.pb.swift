...
public struct VSSingleKeygenMessage {
  ...
  public var singleKeygenType: VSSingleKeygenType = .mldsa
...
extension VSSingleKeygenMessage: @unchecked Sendable {}
...
extension VSSingleKeygenMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".SingleKeygenMessage"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    9: .standard(proto: "lib_type"),
    10: .standard(proto: "single_keygen_type"),
  ]
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 9: try { try decoder.decodeSingularEnumField(value: &self.libType) }()
      case 10: try { try decoder.decodeSingularEnumField(value: &self.singleKeygenType) }()
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if !self.vaultName.isEmpty {
      try visitor.visitSingularStringField(value: self.vaultName, fieldNumber: 8)
    }
    if self.libType != .gg20 {
      try visitor.visitSingularEnumField(value: self.libType, fieldNumber: 9)
    }
    if self.singleKeygenType != .mldsa {
      try visitor.visitSingularEnumField(value: self.singleKeygenType, fieldNumber: 10)
    }
    try unknownFields.traverse(visitor: &visitor)
  }

  public static func ==(lhs: VSSingleKeygenMessage, rhs: VSSingleKeygenMessage) -> Bool {
    ...
    if lhs.singleKeygenType != rhs.singleKeygenType {return false}
